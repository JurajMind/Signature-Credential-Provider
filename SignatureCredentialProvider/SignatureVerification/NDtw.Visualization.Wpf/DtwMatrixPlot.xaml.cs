...
namespace NDtw.Visualization.Wpf
{
    public partial class DtwMatrixPlot : UserControl
    {
        ...
        public void OnDataChanged()
        {
            ...
            if (matrixValues != null)
            {
                ...
                for (var i = 0; i < xLength; i++)
                    for (var j = 0; j < yLength; j++)
                    {
                        ...
                        var intensityBytes = isValuePositiveInfinity
                            ? new byte[] {0, 0, 0}
            ...
            for (var variableIndex = 0; variableIndex < Dtw.SeriesVariables.Length; variableIndex++)
            {
                ...
                for (var i = 0; i < normalizedSeriesA.Count; i++)
                ...
                for (var i = 0; i < normalizedSeriesB.Count; i++)
