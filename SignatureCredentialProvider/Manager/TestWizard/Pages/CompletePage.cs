...
{
    public class CompletePage : ExternalWizardPage
    {
        ...
        public CompletePage()
        {
            ...
            InitializeComponent();
            WizardFinish += CompletePage_Finish;
        }

        private void CompletePage_Finish(object sender, CancelEventArgs e)
        {
        ...
        private void CompletePage_Load(object sender, EventArgs e)
        {
